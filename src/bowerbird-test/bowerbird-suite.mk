...
BOWERBIRD_TEST/CACHE/TESTS_PREV_FAILED/$1 := $$(call bowerbird::test::find-failed-cached-test-results,$$(bowerbird-test.constant.workdir-results)/$1,$$(bowerbird-test.constant.ext-fail))
endif
else
