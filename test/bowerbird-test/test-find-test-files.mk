...
test-find-test-files-count:
	$(call bowerbird::test::compare-strings,6,$(words $(bowerbird::test::mock-test-files)))
...
test-find-test-files-pattern-all-mk:
	$(call bowerbird::test::compare-strings,6,$(words $(call bowerbird::test::find-test-files,test/mock-tests,*.mk)))
...
test-find-test-files-total-count:
	$(call bowerbird::test::compare-strings,6,$(words $(call bowerbird::test::find-test-files,test/mock-tests,mock-test*.mk)))
