...
test-find-test-targets-total-count:
	$(call bowerbird::test::compare-strings,38,$(words $(call bowerbird::test::find-test-targets,test/bowerbird-test/test-find-test-targets.mk,test*)))
...
test-find-test-targets-multiple-patterns:
	$(call bowerbird::test::compare-strings,39,$(words $(call bowerbird::test::find-test-targets,test/bowerbird-test/test-find-test-targets.mk,test* check*)))
